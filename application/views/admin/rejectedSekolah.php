...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('sekolah/exportPDFRejected'); ?>" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
    </div>
                ...
                <tbody class="lazyLoadBody">
                    <?php foreach ($schools as $school) : ?>
                        <tr>
                            ...
                            <td>Rejected <i class="fas fa-fw fa-times text-primary"></i></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
